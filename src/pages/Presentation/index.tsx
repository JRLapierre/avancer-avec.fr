...
import bouquet from "../../assets/page/Presentation/bouquet-fleurs-diverses.jpg"
    ...
    return (
        <div className={styles.content}>
            ...
            <p>
                ...
                Par ma formation au coaching, mon expérience d’écoute et d’accompagnement, j’ai des techniques efficaces pour accompagner des personnes désireuses de progresser dans leur vie.<br/>
                Je désire donc vous en faire profiter.<br/>
                Je vous rencontre soit à votre domicile, soit en distanciel via visioconférence, soit dans la nature…<br/>
                Je suis devenue coach après plus de vingt ans d’expérience d’infirmière scolaire où je me suis aperçue que les élèves et le personnel venaient chercher une écoute active et bienveillante.<br/>
                J’ai vu des personnes dépasser leurs blocages. J’ai donc décidé de mieux m’outiller pour me spécialiser dans l’accompagnement de leurs objectifs.<br/>
                C’est sur mesure, temporaire et confidentiel.<br/>
            ...
            <div style={outerLayer}>
                <div style={innerLayer}>
                    <p className={styles.textSurrounded}>
                        ...
                        trésor qui mérite de l’attention. Je suis curieuse de ce que je vois et aime découvrir et apprendre. <br/>
                        <br/>
                        Ma grande expérience d’accompagnement des ados (infirmière pendant plus de vingt ans dans l’éducation nationale)
                        et d’adultes (engagements bénévoles) m’ont conduit à me diriger vers la formation de coach. <br/>
                        <br/>
                        Après toutes ces années, j’ai décidé de me recentrer sur mes points forts notamment l’écoute active. Parfois
                        frustrée de mes limites, j’ai trouvé dans la formation de coach des outils efficaces. <br/>
                    </p>
                </div>
            </div>
            <p>
